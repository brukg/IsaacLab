...
@configclass
class AllegroHandTD3RunnerCfg(RslRlOffPolicyRunnerCfg):
    """TD3 configuration for Allegro Hand dexterous manipulation."""
...
@configclass
class AllegroHandFastTD3RunnerCfg(RslRlOffPolicyRunnerCfg):
    """FastTD3 configuration for Allegro Hand dexterous manipulation."""
