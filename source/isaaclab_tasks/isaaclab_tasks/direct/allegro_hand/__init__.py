...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_td3_cfg_entry_point": f"{agents.__name__}.rsl_rl_td3_cfg:AllegroHandTD3RunnerCfg",
        "rsl_rl_fast_td3_cfg_entry_point": f"{agents.__name__}.rsl_rl_td3_cfg:AllegroHandFastTD3RunnerCfg",
