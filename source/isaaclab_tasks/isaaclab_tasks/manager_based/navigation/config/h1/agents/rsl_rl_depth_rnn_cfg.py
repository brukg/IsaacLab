...
"""Configuration for RSL-RL Depth CNN + RNN for H1 navigation - DEPTH CAMERA ONLY."""
...
@configclass
class H1NavigationDepthCNNRNNRunnerCfg(RslRlOnPolicyRunnerCfg):
    """Runner configuration for H1 navigation with DEPTH CAMERA + RNN."""

    num_steps_per_env = 24
    max_iterations = 2000
    save_interval = 50
    experiment_name = "h1_navigation_depth_rnn"
